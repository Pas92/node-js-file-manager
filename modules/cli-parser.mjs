...
import { INVALID_INPUT, OPERATION_FAILED } from './app-errors-handler.mjs';
...
const chooseAction = async (chunk) => {
  ...
  await chooseCommand(command, commandArguments);
...
const chooseCommand = async (command, commandArguments) => {
  try {
    switch (command) {
      case 'up':
